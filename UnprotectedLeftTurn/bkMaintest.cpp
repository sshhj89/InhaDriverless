...
int main()
{
    ...
    VideoCapture video("/Users/sonhojun/Downloads/data/test4.mp4");
    ...
    while (1)
    {
        ...
        if(1/*car.getState() == LINEDETECTION*/)
        {
            ...
            Mat laneCrop = car.getLaneFinder().getPriorImage()(Rect(LANECROP_X -100,LANECROP_Y - 100,LANECROP_W +100,LANECROP_H + 80/*- 50*/));
        ...
        if(1/*car.getState() == STOPLINEDETECTED*/)
        {
            video.read(temp);
            origin1 = temp.clone();
            if(temp.channels() == 3)
            ...
            plateCrop= origin(Rect(PLATECROP_X-250,PLATECROP_Y- 100,PLATECROP_W + 100,PLATECROP_H + 100));
        ...
        if(car.getState() == UNPROTECTEDDETECTED)
        {
            ...
            if(car.getPossibleLine() == true)
            {
                cout<<"slope: " <<tInfo[0].getSlope()<<endl;
                cout<<"interY: "<<tInfo[0].getIntX()<<", " << tInfo[0].getIntX()<<endl;
                cout<<" pointY : " <<tInfo[0].getPoint1Y()<<endl;
                D_W = tInfo[0].getPoint1X()+(LANECROP_X + 250 - DIFF_X) /*+ myX*/;
                D_H = tInfo[0].getPoint1Y()+(LANECROP_Y + 300 - DIFF_Y) - BOUNDARYDIFF + 250;
            }
...
//            pMOG->apply(plateCrop, resultMog);
//            imshow("resultMog",resultMog);
            ...
            imshow("greenBin", car.getTrafficFinder().getGreenBin());
